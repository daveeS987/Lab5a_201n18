...
function sumArray(sumArr) { //eslint-disable-line
  ...
  var string = sumArr + ' was passed in as an array of numbers, and ' + totalSum + ' is their sum.';
...
function multiplyArray(multArr) { //eslint-disable-line
  ...
  for (var j = 0; j < multArr.length; j++) {
    product = multiply(product, multArr[j])[0];
  }
  var string = 'The numbers ' + multArr + ' have a product of ' + product + '.';
  return [product, string];
}
